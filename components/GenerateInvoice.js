...
const GenerateInvoice = () => {
  ...
  return (
    <>
      <section>
        <div className="container mx-auto flex flex-col w-full px-3 md:px-5 lg:px-8 py-20">
          <div className="w-full flex flex-col md:flex-row justify-center gap-4 md:gap-2 md:justify-between">
            ...
            <div className="w-full max-w-[680px] rounded-[20px] border border-[#c2bcba] p-5 shadow-[6px_6px_0px_rgba(0,0,0,0.1)]">
